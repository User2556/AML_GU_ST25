...
class MIFS_MLPClassifier(BaseClassifier):
    def __init__(self, mifs_info, width_list, num_in_feat, num_out_classes, **kwargs):
        super().__init__(**kwargs)

        self.mifs_info = mifs_info #[mi_arch_path, repr_dimension]
    ...
    def _build_model(self):
        mi_arch = np.load(self.mifs_info[0])
        self.filter = mi_arch[:self.mifs_info[1]]
